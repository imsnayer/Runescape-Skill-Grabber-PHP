function fetchData() {
	...
	//storing all RuneScape skill names inside a 1 dimensional JS array
	...
	if(tmpUser == "")
		...
		//storing RuneScape data URL for username entered, inside variable url
				...
				if(xmlHttp.status === 200){
					...
					if(resp.indexOf("404") != -1)
						...
						for(var i = 0; i < lines.length; i++){
							...
							//is what the function Split is doing in this scenario)
